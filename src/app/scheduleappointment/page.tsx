        ...
        <div className="min-h-screen bg-slate-50 relative overflow-hidden font-sans text-slate-800">
            ...
            <div className="max-w-4xl mx-auto px-6 py-16 flex flex-col items-center justify-center min-h-[80vh]">
                ...
                <div className="w-full mb-8 animate-fade-in">
                    <Link href="/homepatiente" className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white border border-slate-200 text-slate-600 hover:text-cyan-600 hover:border-cyan-200 hover:bg-cyan-50 transition-all shadow-sm group">
