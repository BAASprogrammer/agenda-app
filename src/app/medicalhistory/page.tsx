        ...
        <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row font-sans text-slate-800">
            ...
            <aside className="w-full md:w-64 bg-white border-r border-slate-200 flex flex-col z-20">
                ...
                <nav className="flex-1 p-4 space-y-2">
                    ...
                    <Link href="/myappointments" className="flex items-center gap-3 px-4 py-3 text-slate-600 hover:bg-slate-50 hover:text-cyan-600 rounded-xl font-medium transition-all">
                        <CalendarDays className="w-5 h-5" />
                        Mis Citas
                    </Link>
                    <Link href="/medicalhistory" className="flex items-center gap-3 px-4 py-3 bg-cyan-50 text-cyan-700 rounded-xl font-medium transition-all">
