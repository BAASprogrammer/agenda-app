...
export default function MyAppointments() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row font-sans text-slate-800">
            {/* Sidebar (Copy from Home) */}
            <aside className="w-full md:w-64 bg-white border-r border-slate-200 flex flex-col z-20">
                <div className="p-6 border-b border-slate-100 flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-linear-to-br from-cyan-500 to-blue-500 flex items-center justify-center shadow-md">
                ...
                <nav className="flex-1 p-4 space-y-2">
                    <Link href="/homepatiente" className="flex items-center gap-3 px-4 py-3 text-slate-600 hover:bg-slate-50 hover:text-cyan-600 rounded-xl font-medium transition-all">
                        <HeartPulse className="w-5 h-5" />
                        Mi Resumen
                    </Link>
                    <Link href="/myappointments" className="flex items-center gap-3 px-4 py-3 bg-cyan-50 text-cyan-700 rounded-xl font-medium transition-all">
                        <CalendarDays className="w-5 h-5" />
                        Mis Citas
                    </Link>
                    <Link href="/medicalhistory" className="flex items-center gap-3 px-4 py-3 text-slate-600 hover:bg-slate-50 hover:text-cyan-600 rounded-xl font-medium transition-all">
                        <FileText className="w-5 h-5" />
                        Historial Médico
                    </Link>
                    <Link href="/profile" className="flex items-center gap-3 px-4 py-3 text-slate-600 hover:bg-slate-50 hover:text-cyan-600 rounded-xl font-medium transition-all">
            ...
            <main className="flex-1 flex flex-col relative overflow-hidden">
                ...
                <header className="px-8 py-8 flex flex-col md:flex-row md:items-center justify-between gap-4 animate-fade-in">
                    <div>
                        <Link href="/homepatiente" className="text-cyan-600 flex items-center gap-1 text-sm font-bold mb-2 hover:gap-2 transition-all">
