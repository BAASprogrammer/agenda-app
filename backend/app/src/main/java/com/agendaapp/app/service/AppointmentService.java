        ...
        public Map<String, Object> createAppointment(AppointmentRequest body) {
                ...
                if (timeConflictCount != null && timeConflictCount > 0) {
                        throw new AppointmentAlreadyExistsException(
                                        "Error: Ya tienes una cita programada en la misma fecha y hora");
                }
                ...
                if (subspecialtyConflictCount != null && subspecialtyConflictCount > 0) {
                        throw new AppointmentAlreadyExistsException(
                                        "Error: Ya tienes una cita con la misma especialidad y subespecialidad");
                }
                ...
                if (existingCount != null && existingCount > 0) {
                        throw new AppointmentAlreadyExistsException(
                                        "Error: El paciente ya tiene una cita con este profesional");
                }
